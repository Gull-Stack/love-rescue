#!/usr/bin/env python3
"""
Video list with real IDs from yt-dlp search results.
This script outputs JSON for the browser-based transcript scraper.
"""
import json

# All videos to scrape - real video IDs from yt-dlp searches
VIDEOS = {
    "gottman": [
        ("AKTyPgwfPgg", "Making Marriage Work | Dr. John Gottman", "The Gottman Institute", "~21 min"),
        ...
        ("xp92hIfvyk0", "How To Fight Right With Your Partner - Q&A w/ The Gottmans", "Matthias J Barker", "~78 min"),
...
print(f"\nTotal: {sum(len(v) for v in VIDEOS.values())} videos")
